"""AumOS Government/Defense Overlay service entry point."""
...
from aumos_govdef_overlay.api.router import router
from aumos_govdef_overlay.settings import Settings
...
app: FastAPI = create_app(
    service_name="aumos-govdef-overlay",
    version="0.1.0",
    settings=settings,
    lifespan=lifespan,
    health_checks=[
