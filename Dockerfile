# ============================================================================
# Dockerfile — aumos-govdef-overlay
# Multi-stage build for Government/Defense overlay service
# ============================================================================
...
# Start service
CMD ["uvicorn", "aumos_govdef_overlay.main:app", "--host", "0.0.0.0", "--port", "8000", "--workers", "1"]
